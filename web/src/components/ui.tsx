...
export function Button({
  ...
  return (
    <button
      className={clsx(
        "inline-flex items-center justify-center gap-1.5 rounded-md font-medium transition focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
        ...
        variant === "ghost" && "text-slate-600 hover:bg-slate-200/70",
...
export function Modal({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "my-4 w-full rounded-xl bg-slate-50 shadow-xl",
